...
def process_uploaded_file(file_path: str, user_id: str, index_manager):
    """
    Main function to process any supported file type.
    Changed org_id / ord_id → user_id.
    """
    ...
    # 2. Create or update FAISS index for this user
    index_manager.create_index(user_id, paragraphs)
