...
export const mutations = `
  ...
  savingsContractDealEdit(_id: String!, ${commonFields}): SavingContract
  savingsContractsClose(contractId: String, closeData: Date, closeType: String, description: String): SavingContract
