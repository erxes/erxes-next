...
export const sendPosMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('pos', args);
};

export const sendCoreMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('core', args);
};

export const sendInventoriesMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('inventories', args);
};

export const sendSalesMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('sales', args);
};

export const sendInboxMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('inbox', args);
};

export const sendLoyaltiesMessage = async (args: any): Promise<any> => {
  return sendMessageWrapper('loyalties', args);
};

export const sendPricingMessage = async (args: any): Promise<any> => {
