...
export interface IFacebookCustomerModel extends Model<IFacebookCustomerDocument> {
  getCustomer(selector: any, isLean?: boolean): Promise<IFacebookCustomerDocument>;
}
