...
export const transactionSchema = new Schema({
  ...
  followType: {
    ...
    label: 'This follow Type',
    enum: TR_FOLLOW_TYPES.ALL,
  }, // Уг бичилтийн үндсэн бичилтэд хавсарч буй үүрэг буюу төрөл - дагалдах бичилт үед л ашиглагдана
  originSubId: {
    type: String,
    optional: true,
    label: 'Source Sub Transaction',
  }, // Үндсэн бичилтийн дэд листээс хамаарсан бол ашиглагдана. Жишээлбэл барааны орлогын зардал бүрээс хамаарсан олон бичилт үүсэх бол
  followInfos: {
  ...
  follows: {
    // Үндсэн бичилт үед ашиглагдана, Дагалдах бичилтүүдийн айд төрөл байна
    type: [followSchema],
    label: 'Follower transactions',
  },
  preTrId: {
