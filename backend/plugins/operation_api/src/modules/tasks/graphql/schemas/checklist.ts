...
export const queries = `
  tasksChecklists(contentTypeId: String): [TasksChecklist]
  tasksChecklistDetail(_id: String!): TasksChecklist
`;

export const mutations = `
  tasksChecklistsAdd(contentTypeId: String, title: String): TasksChecklist
  tasksChecklistsEdit(_id: String!, title: String, contentTypeId: String): TasksChecklist
