...
export default function ChooseCategoryPage() {
  ...
  const handleCategorySelect = (category: string) => {
    ...
    localStorage.setItem("posCategory", category)
  }
  ...
  const handleNextStep = () => {
    if (selectedCategory) {
      ...
      alert("Please select a category before proceeding to the next step.")
    }
  }
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <Button
                ...
                size="sm"
                className={selectedCategory === "ecommerce" ? "bg-green-600 hover:bg-green-700" : ""}
              >
          ...
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <Button
                ...
                size="sm"
                className={selectedCategory === "restaurant" ? "bg-green-600 hover:bg-green-700" : ""}
              >
        ...
        <div className="relative overflow-hidden rounded-lg border border-gray-200 shadow-sm">
          <div className="h-48 overflow-hidden">
            <img src="/placeholder.svg?height=192&width=384" alt="Kiosk POS" className="w-full h-full object-cover" />
          </div>
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <Button
                ...
                size="sm"
                className={selectedCategory === "kiosk" ? "bg-green-600 hover:bg-green-700" : ""}
              >
