...
const DeliveryConfigForm = forwardRef<DeliveryConfigFormRef, DeliveryConfigFormProps>(
  ({ form: externalForm, onFormSubmit, posDetail }, ref) => {
    const [selectedWatchedUserId, setSelectedWatchedUserId] = useState<string>("")
    ...
    useEffect(() => {
      if (posDetail?.deliveryConfig) {
        ...
        form.reset({
          ...
          pipeline: deliveryConfig.stage?.pipeline || deliveryConfig.pipeline || "",
          stage: deliveryConfig.stage?.stage || deliveryConfig.stage || "",
          watchedUsers: watchedUserId,
          assignedUsers: assignedUserId,
          deliveryProduct: deliveryConfig.product?.deliveryProduct || deliveryConfig.deliveryProduct || "",
    ...
    const handleSelectChange = (field: keyof DeliveryConfigFormValues, value: string) => {
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[#A1A1AA] text-xs font-semibold">USER ASSIGNMENTS</p>
            </div>
