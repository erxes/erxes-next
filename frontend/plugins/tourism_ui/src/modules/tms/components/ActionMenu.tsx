	...
	return (
		<Popover>
			...
			>
				...
				<div
					className={`flex items-center w-full gap-3 px-4 py-2 text-left cursor-pointer hover:bg-muted rounded-md ${duplicateLoading ? 'opacity-50 pointer-events-none' : ''
						}`}
				...
				>
					...
					<p className="text-sm font-medium leading-[100%] font-inter">Delete</p>
				</div>
			</Popover.Content>
		</Popover>
	);
