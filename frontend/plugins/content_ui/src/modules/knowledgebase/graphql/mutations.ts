...
export const EDIT_TOPIC = gql`
    mutation knowledgeBaseTopicsEdit($_id: String!, $input: KnowledgeBaseTopicInput!) {
...
export const EDIT_CATEGORY = gql`
    mutation knowledgeBaseCategoriesEdit($_id: String!, $input: KnowledgeBaseCategoryInput!) {
...
export const EDIT_ARTICLE = gql`
    mutation knowledgeBaseArticlesEdit($_id: String!, $input: KnowledgeBaseArticleInput!) {
