...
import {
  ...
  CONVERSATION_EXTERNAL_INTEGRATION_MESSAGE_INSERTED,
} from '../graphql/subscriptions/inboxSubscriptions';
...
export const useConversations = (
  ...
  useEffect(() => {
    ...
    const unsubscribeExternalIntegration = subscribeToMore({
      document: CONVERSATION_EXTERNAL_INTEGRATION_MESSAGE_INSERTED,
      variables: {
        userId,
      },
      updateQuery: (prev, { subscriptionData }) => {
    ...
    return () => {
      unsubscribe();
      unsubscribeExternalIntegration();
    };
  }, []);
