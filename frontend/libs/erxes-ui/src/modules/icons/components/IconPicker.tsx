...
export const IconPicker = forwardRef<HTMLButtonElement, React.ComponentProps<typeof Combobox.TriggerBase> & {
  value?: string;
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <Combobox.TriggerBase variant="ghost" size="icon" className="px-2" ref={ref} {...props}>
