...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 px-3 whitespace-nowrap rounded-md text-sm transition-colors outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-medium HI LALARAA',
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'ring-1 ring-input bg-background shadow-button-outline hover:bg-accent hover:text-accent-foreground',
        secondary:
          'bg-secondary text-secondary-foreground shadow-sm shadow-black/5 hover:bg-secondary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'ring-1 ring-input bg-background shadow-button-outline hover:bg-accent text-primary',
      },
      size: {
        default: 'h-7 py-1',
