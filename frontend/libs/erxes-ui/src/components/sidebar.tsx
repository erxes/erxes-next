  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 uppercase font-mono',
        className,
      )}
      {...props}
    />
