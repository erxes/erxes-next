  ...
  return (
    <ScrollArea.Root>
      <section className="mx-auto max-w-2xl w-full relative">
        <SettingsBreadcrumbs breadcrumbs={[{ title: "Setting", path: "settings" }, { title: "General", path: "general" }]} />
        <h2 className="font-semibold text-lg mt-4 mb-12 px-4">General settings</h2>
