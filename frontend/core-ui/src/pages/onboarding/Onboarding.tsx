          ...
          <Card.Content className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-muted-foreground">
                ...
                are actively working to upgrade the entire platform. Every day,
                you'll see new improvements.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-center text-muted-foreground">
                Your input is essential! Share your thoughts and help us refine
                this new experience.
              </p>
