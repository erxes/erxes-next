...
import DataTraining from "@/aiassistant/dataTraining";
import General from "@/aiassistant/general";
import SystemPrompt from "@/aiassistant/systemPrompt";

const AIAssistant = () => {
  const [activeTab, setActiveTab] = useState<"general" | "training" | "system">("general");
