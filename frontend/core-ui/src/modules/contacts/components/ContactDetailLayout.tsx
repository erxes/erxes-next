...
import { CustomerDetailActionsTrigger } from '../customers/customer-detail/components/CustomerDetailActions';
import { CustomerDetailSheet } from '../customers/customer-detail/components/CustomerDetailSheet';
