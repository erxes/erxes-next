    ...
    <div className="space-y-8 p-6 overflow-y-auto h-[900px] bg-white rounded-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="space-y-2">
          <Label htmlFor="product-name" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            PRODUCT NAME
          </Label>
          <Input
            id="product-name"
        ...
        <div className="space-y-2">
          <Label htmlFor="barcodes" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            BARCODES
          </Label>
          <Input
            id="barcodes"
        ...
        <div className="space-y-2">
          <Label htmlFor="code" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            CODE
          </Label>
          <Input
            id="code"
        ...
        <div className="space-y-2">
          <Label htmlFor="category" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            CATEGORY
          </Label>
          <SelectCategory
            selected={categoryId}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="unit-price" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
              UNIT PRICE
            </Label>
          </div>
          {isEditingPrice ? (
            <div className="flex items-center space-x-2">
              <div className="flex-grow">
                <CurrencyInput value={priceValue} onChange={(value: number) => setPriceValue(value)} />
              </div>
              <div className="flex space-x-1">
                <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white" onClick={handleSavePrice}>
                  Save
                </Button>
        ...
        <div className="space-y-2">
          <Label htmlFor="category-display" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            STATUS
          </Label>
          <Input
            id="category-display"
        ...
        <div className="space-y-2">
          <Label htmlFor="type" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            TYPE
          </Label>
          <Select defaultValue={type} onValueChange={(value) => handleInputChange("type", value)}>
        ...
        <div className="space-y-2">
          <Label htmlFor="uom" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            UNIT OF MEASUREMENTS
          </Label>
          <Select value={uom} onValueChange={(value) => handleInputChange("uom", value)}>
            <Select.Trigger className="w-full border-gray-200 rounded-md focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-all">
        ...
        <div className="space-y-2">
          <Label htmlFor="brand" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            BRAND
          </Label>
          <BrandField values={scopeBrandIds || []} onChange={(value) => handleInputChange("scopeBrandIds", value)} />
        </div>

        <div className="space-y-2">
          <Label htmlFor="vendor" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            VENDOR
          </Label>
          <VendorField value={vendorId || ""} onChange={(value) => handleInputChange("vendorId", value)} />
        </div>

        <div className="space-y-2">
          <Label htmlFor="short-name" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
            SHORT NAME
          </Label>
          <Input
            id="short-name"
        ...
        <div className="space-y-2">
          <Label className="text-xs font-semibold text-gray-500 tracking-wider mb-1">PDF</Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="description" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
          DESCRIPTION
        </Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="barcode-description" className="text-xs font-semibold text-gray-500 tracking-wider mb-1">
          BARCODE DESCRIPTION
        </Label>
        <div className="h-60 border rounded-md overflow-hidden shadow-sm hover:shadow transition-shadow">
          <DescriptionInput
      ...
      <div className="space-y-2">
        <Label className="text-xs font-semibold text-gray-500 tracking-wider mb-1">FEATURED IMAGE</Label>
        <div className="border-2 border-dashed rounded-lg p-6 text-center bg-gray-50 hover:bg-gray-100 transition-colors">
          {attachment ? (
            <div className="flex flex-col items-center">
              <img src={attachment.url || "/placeholder.svg"} alt={name || "Product"} className="max-h-40 mb-2" />
              <Button variant="outline" className="mt-2 border-indigo-300 text-indigo-600 hover:bg-indigo-50">
      ...
      <div className="space-y-2">
        <Label className="text-xs font-semibold text-gray-500 tracking-wider mb-1">SECONDARY IMAGES</Label>
        <div className="border-2 border-dashed rounded-lg p-6 text-center bg-gray-50 hover:bg-gray-100 transition-colors">
